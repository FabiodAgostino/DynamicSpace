...
public class DynamicSpaceDbMigrationService : ITransientDependency
{
    public ILogger<DynamicSpaceDbMigrationService> Logger { get; set; }
    ...
    public DynamicSpaceDbMigrationService(
        ...
        IEnumerable<IDynamicSpaceDbSchemaMigrator> dbSchemaMigrators)
    {
        ...
        Logger = NullLogger<DynamicSpaceDbMigrationService>.Instance;
    }
